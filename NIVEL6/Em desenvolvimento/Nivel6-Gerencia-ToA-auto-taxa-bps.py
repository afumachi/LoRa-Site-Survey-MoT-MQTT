...
janela_principal.title("LORA SITE SURVEY VERSÃO ESP32 - ToA AUTOMÁTICO") # Função para alterar titulo da janela
...
reg_parametrizacao.place(x=10,y=10,width=300,height=320) 
...
bot_ini_teste.place(x=25,y=240) 
...
reg_desempenho.place(x=10,y=335,width=300,height=610) #height=360

titulo_desempenho = Label(reg_desempenho, font=("Arial", 14, "bold"),text = "Intensidade do Sinal",padx=5,pady=5).pack(side=TOP, anchor="n")
...
RPSR = Label(janela_principal, font=("Arial", 13, "bold"), text="PSR (Geral)", fg="green", padx=5, pady=5)
RPSR.place(x=1090, y=100, anchor="w")

RTCH = Label(janela_principal, font=("Arial", 13, "bold"), text="Taxa Teórica", fg="green", padx=5, pady=5)
RTCH.place(x=1090, y=200, anchor="w")

RTCHRE = Label(janela_principal, font=("Arial", 13, "bold"), text="Taxa Calculada", fg="green", padx=5, pady=5)
RTCHRE.place(x=1090, y=300, anchor="w")
...
# --- LABELS PSR ---
lbl_atual_psr = Label(janela_principal, font=("Arial", 14, "bold"),textvariable = str_atual_psr,padx=5,pady=2)
lbl_atual_psr.place(x=1090, y=130, anchor="w") 


# --- LABELS TAXA DO CANAL ---
lbl_atual_taxa_canal = Label(janela_principal, font=("Arial", 12, "bold"),textvariable = srt_atual_taxa_canal,padx=5,pady=2)
lbl_atual_taxa_canal.place(x=1090, y=230, anchor="w") 

# --- LABELS TAXA REAL DO CANAL ---
lbl_atual_taxa_real_canal = Label(janela_principal, font=("Arial", 12, "bold"),textvariable = srt_atual_taxa_real_canal,padx=5,pady=2)
lbl_atual_taxa_real_canal.place(x=1090, y=330, anchor="w") 
...
reg_grafico.place(x=330, y=10, width=750, height=790) #height=790
#-------------------------------------------------------------------------------
