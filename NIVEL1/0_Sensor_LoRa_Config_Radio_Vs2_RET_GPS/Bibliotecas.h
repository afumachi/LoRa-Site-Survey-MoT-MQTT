...
int SNR_DL;           // Variável inteira para enviar a SNR, que será convertida para a SNR original no Python
...
unsigned long millis_standby_controle = 0;   // Marca o instante em que pacote fo recebido
